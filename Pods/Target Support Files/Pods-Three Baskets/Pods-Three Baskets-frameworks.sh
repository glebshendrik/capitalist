...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RecurrencePicker/RecurrencePicker.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SaltEdge-iOS-Swift/SaltEdge.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/StaticTableViewController/StaticTableViewController.framework"
